...
export const createLinkSchema = z
  .object({
    ...
    brandLogoUrl: z.string().trim().url("Must be a valid URL").regex(/^https:\/\//, "Must be HTTPS URL").max(1000).nullable().optional().or(z.literal("")),
...
export const adminSettingsSchema = z.object({
  ...
  developerProfile: z.record(z.string(), z.unknown()).optional(),
  developer_profile: z.record(z.string(), z.unknown()).optional(),
  settings: z
    .object({
      maintenance_mode: z.union([z.boolean(), z.string().transform((v) => v === "true")]).optional(),
      maintenanceMode: z.union([z.boolean(), z.string().transform((v) => v === "true")]).optional(),
